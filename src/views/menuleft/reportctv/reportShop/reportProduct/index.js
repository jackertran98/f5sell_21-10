                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                    ...
                    <View style={styles.container}>
                        <Picker
                            ...
                            style={{ height: 35, width: sizeWidth(38) }}
                            onValueChange={(itemValue, itemIndex) => this.setState({ selectedValue: itemValue }, this.handle())}
                        >
                    ...
                    <View>
                        {selectedValue == 1 ? <View style={styles.container}>
                            <Picker
                                selectedValue={selectedYear}

                                style={{ height: 35, width: sizeWidth(27) }}
                                onValueChange={(itemValue, itemIndex) => this.setState({ selectedYear: itemValue }, () => this.handle())}
                            >
                                ...
                                <Picker
                                    selectedValue={selectedMoth}
                                    style={{ height: 35, width: sizeWidth(20) }}
                                    onValueChange={(itemValue, itemIndex) => this.setState({ selectedMoth: itemValue })}
                                >
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around', marginTop: 10 }}>
                    ...
                    <View style={styles.container}>
                        <Picker
                            ...
                            onValueChange={(itemValue, itemIndex) => this.setState({ isselectedValue: itemValue })}
                        >
                            <Picker.Item label="Danh mục sản phẩm" value="1" />
                            <Picker.Item label="Thuộc tính sản phẩm" value="2" />
                            <Picker.Item label="Sản phẩm" value="4" />
                        </Picker>
                    </View>
                </View>
