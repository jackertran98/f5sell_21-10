        ...
        return (
            <ScrollView nestedScrollEnabled = {true}>
                <View style={{ height:sizeHeight(13) , width: '100%' }}>
                    <Text style={{ height: sizeHeight(5), borderRadius: 5, backgroundColor: 'black', color: 'white', textAlign: 'center', paddingTop: 8, fontSize: 16, marginTop: 10 }}>
                ...
                <View>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                        <TextInput
                            ...
                            onChangeText={(num)=>this.onPrice(num)}
